...
class OptionsTest {
    ...
    void oauthCannotBeCombinedWithBasicAuthenticationFromFile() {
        var configured = new Properties(null, null, "user", "pass", true, true, false, null, null, null, 10, 20, 30);
    ...
    void certificateFlagReplacesAlternativeFromFile() {
        var configured =
                new Properties(null, null, null, null, true, true, false, "old certificate", null, null, 10, 20, 30);
    ...
    void booleanFlagsCanExplicitlyEnableOrDisableFileValues() {
        var configured = new Properties(null, null, null, null, false, false, true, null, null, null, 10, 20, 30);
