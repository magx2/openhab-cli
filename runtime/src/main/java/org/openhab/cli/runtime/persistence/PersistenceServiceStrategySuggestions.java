...
public class PersistenceServiceStrategySuggestions implements Callable<Integer> {
    @CommandLine.Mixin
    ...
    /** Executes {@link Persistence#persistenceServiceStrategySuggestions} and returns zero on success. */
    @Override
    public Integer call() {
